...
export function Financials() {
  ...
  if (!hasFinancial) {
    return (
      <>
        <PageHeader title="财务分析" subtitle="利润表 / 资负表 / 现金流 / 关键指标 / AI分析 · 免费源可用" />
        <div className="px-8 py-10">
          <div className="mx-auto max-w-md rounded-card border border-warning/30 bg-warning/[0.04] p-8 text-center">
            ...
            <h3 className="mt-4 text-base font-semibold text-foreground">财务数据暂不可用</h3>
            <p className="mt-2 text-xs leading-relaxed text-secondary">
              当前数据源未启用财务能力。默认 akshare 免费源已提供财务数据,
              请在「设置 → 数据源」将历史/盘后数据源设为 akshare,或填写 TickFlow 付费 Key。
            </p>
            {/* 当前财务数据源:akshare 免费已可用;TickFlow 付费档亦支持。 */}
            <div className="mt-5 rounded-btn border border-accent/25 bg-accent/[0.05] px-3.5 py-3 text-left">
              ...
              <p className="mt-1.5 text-[11px] leading-relaxed text-secondary">
                默认 akshare 免费源即提供利润表/资负表/现金流/核心指标,无需 Key。
                如需更全的财务维度,可在「设置 → 数据源」填写 TickFlow 付费 Key。
              </p>
              <a
                href="https://github.com/chiyoumask/quantforge/issues"
                target="_blank"
                rel="noreferrer"
  ...
  return (
    <>
      <PageHeader
        title="财务分析"
        subtitle="利润表 / 资负表 / 现金流 / 关键指标 / AI分析 · 免费源可用"
        right={
